...
//activarla 57-58 player.addAnimation("hit",shooter_shooting);
...
// esta desactivar 110 player.changeAnimation("hit")
  //player.changeAnimation("hit");
  player.changeAnimation("start")
 //activarplayer.scale = 0.7 
}

//player goes back to original standing image once we stop pressing the space bar
/* activarla else if(keyWentUp("space")){
  //player.addAnimation("start",shooterImg)
  player.changeAnimation("start")
  player.scale = 1.2 
}*/
